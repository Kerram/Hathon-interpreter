...
showSExpValue (FunValue _) = Left $
  newST $ showString "RUNTIME ERROR: Cannot display functional type!"
...
expValueEq (FunValue _) (FunValue _) = Left $
  newST $ showString "RUNTIME ERROR: Cannot check equality between functional types!"
...
expValueEq _ _ = Left $ newST $
  showString "RUNTIME ERROR: Cannot check equality between objects of different types!"
